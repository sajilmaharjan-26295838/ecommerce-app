...
const styles = {
  ...
  addBtn: { background: "#4f46e5", color: "white", border: "none", padding: "10px 20px", borderRadius: "8px", cursor: "pointer", fontSize: "15px" },
  ...
  submitBtn: { background: "#4f46e5", color: "white", border: "none", padding: "10px 24px", borderRadius: "8px", cursor: "pointer", fontSize: "15px" },
  ...
  productPrice: { fontSize: "20px", fontWeight: "bold", color: "#4f46e5", margin: "0 0 0.75rem" },
  cartBtn: { width: "100%", padding: "8px", background: "#4f46e5", color: "white", border: "none", borderRadius: "8px", cursor: "pointer", fontSize: "14px", marginBottom: "0.5rem" },
